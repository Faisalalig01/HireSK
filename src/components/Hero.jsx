  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        viewport={{ once: true }}
        className="text-4xl sm:text-5xl md:text-6xl xl:text-[50px] font-mOedium xl:leading-[60px] max-w-5xl"
      >
        Sales Enablement &{" "}
      ...
      >
        We fuel your growth with the right people, tools, and outreach.
        You close more deals through a stronger, predictable sales pipeline.
      </motion.p>
